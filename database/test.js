...
db.once('open', function() {
	...
	console.log(user);
        ...
        create_System("Hoyin", "7601963", "Jason", "5100", "HPE-Jason 5100", "1.1.1.1", "2018-04-17", 127.234123, 111.33334, 43.5555, 22.45555, 0.022212312, 16, 2562).then(function(stuff){
	console.log(stuff);
    });
    create_System("Hoyin", "7160363", "Billy", "Z10", "HPE-Billy Z10", "1.2.3.4", "2018-04-16", 131.4123, 67.33334, 15.345, 10.45555, 0.022212312, 16, 2562).then(function(stuff){
	console.log(stuff);
    });
});
