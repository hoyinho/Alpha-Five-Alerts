					...
					if(sysFilt[i][0] === a2["systemName"]){
						...
						//if the alertfield exists here, then...
							...
							if(sysFilt[i][2][a2["alertField"]] >= a2["alertThreshold"]){
								response[i+1].push(a2["alertName"] + ": " + a2["alertField"] + ": " + sysFilt[i][2][a2["alertField"]] + " is greater than " + a2["alertThreshold"]);
							}
						}
						//if the alertfield exists here, then...
							...
							if(sysFilt[i][3][a2["alertField"]] <= a2["alertThreshold"]){
								response[i+1].push(a2["alertName"] + ": " + a2["alertField"] + ": " + sysFilt[i][3][a2["alertField"]] + " is less than " + a2["alertThreshold"]);
							}
