					...
					if(sysFilt[i][0] === a2["systemName"]){
						...
						if(sysFilt[i][1][a2["alertField"]]){
							...
							if(a2["alertField"] === "failedCapacityTiB"){
								...
								//console.log("\nALERT!!!!!\n")
								response[i+1].push(a2["alertName"] + ": " + sysFilt[i][1][a2["alertField"]] + " has passed " + a2["alertThreshold"]);
							}
						}
						//if the alertfield exists here, then...
							...
							if(sysFilt[i][2][a2["alertField"]] >= a2["alertThreshold"]){
								//console.log("\nALERT!!!!!\n")
								response[i+1].push(a2["alertName"] + ": " + sysFilt[i][2][a2["alertField"]] + " has passed " + a2["alertThreshold"]);
							}
						}
						//if the alertfield exists here, then...
							...
							if(sysFilt[i][3][a2["alertField"]] <= a2["alertThreshold"]){
								//console.log("\nALERT!!!!!\n")
								response[i+1].push(a2["alertName"] + ": " + sysFilt[i][3][a2["alertField"]] + " has passed " + a2["alertThreshold"]);
							}
